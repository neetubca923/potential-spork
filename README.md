...
This is a personal portfolio website designed to showcase my journey as a BCA student and an aspiring Web Developer.

## 🌟 About Me
I am a BCA student currently learning the fundamentals of web development. My goal is to become a professional Software Developer by mastering modern web technologies.

## 🛠️ Skills
- **HTML5:** For building structured and semantic web pages.
- **CSS3:** For styling, layout design, and responsiveness.
- **Basic JavaScript:** For adding interactivity to websites.
- **Computer Basics:** Strong foundational knowledge of computing.

## 📂 Projects
1. **Portfolio Website:** A personal site created using HTML & CSS to display my skills and contact details.
2. **First HTML Project:** My very first basic website created as a beginner to practice HTML tags.
